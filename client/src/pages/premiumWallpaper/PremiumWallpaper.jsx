...
const PremiumWallpaper = () => {
    ...
    useEffect(() => {
        const cachedData = sessionStorage.getItem('premium');
        ...
        if (cachedData) {
            ...
            client
                ...
                .then((fetchedData) => {
                    setData(fetchedData);
                    sessionStorage.setItem('premium', JSON.stringify(fetchedData));
                })
                .catch(console.error)
                .finally(() => {
                    setLoading(false);
    ...
    return (
        <>
            <Helmet>
                <title>Premium Wallpapers</title>
                            ...
                            >
                                ...
                                <div className="listBot">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <button onClick={() => navigate(`/premiumWallpaper/${item._id}`)}>
                                            READ MORE
                                        </button>
                                        <Wp />
                                    </div>
...
export default PremiumWallpaper;
